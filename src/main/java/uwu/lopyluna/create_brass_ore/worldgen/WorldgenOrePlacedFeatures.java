...
public class WorldgenOrePlacedFeatures {
    public static final DeferredRegister<PlacedFeature> PLACED_FEATURES =
            DeferredRegister.create(Registry.PLACED_FEATURE_REGISTRY, BrassCreate.MOD_ID);


    public static final RegistryObject<PlacedFeature> BRASS_ORE_PLACED = PLACED_FEATURES.register("brass_ore_placed",
            () -> new PlacedFeature(WorldgenOreFeatures.brass_ore.getHolder().get(),
                    commonOrePlacement(16,
                            HeightRangePlacement.triangle(VerticalAnchor.absolute(-32), VerticalAnchor.absolute(0)))));
